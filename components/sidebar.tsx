...
const navigation = [
  ...
  { id: 'reports', name: 'Reports', icon: BarChart3, gradient: 'from-purple-500 to-pink-600' },
  { id: 'settings', name: 'Settings', icon: Settings, gradient: 'from-orange-500 to-red-600' },
];
